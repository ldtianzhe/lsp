    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="性别" align="center" prop="sex" :formatter="sex"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="750px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="归属部门" prop="deptId" label-width="100px">
          ...
          <el-col :span="12">
            <el-form-item label="实名认证" label-width="100px">
              <el-select v-model="form.realName" placeholder="请选择">
                <el-option
                  v-for="dict in certOptions"
                  :key="dict.dictValue"
                  :label="dict.dictLabel"
                  :value="dict.dictValue"
                ></el-option>
          ...
          <el-col :span="12">
            <el-form-item label="企业认证" label-width="100px">
              <el-select v-model="form.realEnterprise" placeholder="请选择">
                <el-option
                  v-for="dict in certOptions"
                  :key="dict.dictValue"
                  :label="dict.dictLabel"
          ...
          <el-col :span="12">
            <el-form-item label="用电信息认证" label-width="100px">
              <el-select v-model="form.realElectro" placeholder="请选择">
                <el-option
                  v-for="dict in certOptions"
                  :key="dict.dictValue"
                  :label="dict.dictLabel"
          ...
          <el-col :span="12">
            <el-form-item label="职业认证" label-width="100px">
              <el-select v-model="form.realOccupation" placeholder="请选择">
                <el-option
                  v-for="dict in certOptions"
                  :key="dict.dictValue"
                  :label="dict.dictLabel"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      sex(row) {
        return row.sex == 2? '未知':(row.sex == 0? '男':'女')
      },
      /** 查询部门下拉树结构 */
      getTreeselect() {
      ...
      reset() {
        this.form = {
          ...
          status: "0",
          realName: undefined,
          realEnterprise: undefined,
          realElectro: undefined,
          realOccupation: undefined,
          remark: undefined,
          postIds: [],
          roleIds: []
        };
