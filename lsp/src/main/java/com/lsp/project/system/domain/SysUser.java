...
public class SysUser extends BaseEntity {
     ...
     * 实名认证状态
     */
    @Excel(name = "实名认证状态", readConverterExp = "0=未认证,1=认证中")
    private String realName;

    /**
     * 企业认证状态
     */
    @Excel(name = "企业认证状态", readConverterExp = "0=未认证,1=认证中,2=已认证")
    private String realEnterprise;

    /**
     * 用电信息认证状态
     */
    @Excel(name = "用电信息认证状态", readConverterExp = "0=未认证,1=认证中,2=已认证")
    private String realElectro;

    /**
     * 职业认证状态
     */
    @Excel(name = "职业认证状态", readConverterExp = "0=未认证,1=认证中,2=已认证")
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
                ...
                .append("realEnterprise" , getRealEnterprise())
                .append("realElectro" , getRealElectro())
                .append("realOccupation" , getRealName())
